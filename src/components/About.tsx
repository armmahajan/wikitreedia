    ...
    return (
      ...
      >
        <div className="w-1/3 h-max bg-[#161618] rounded-3xl py-4 px-6 flex flex-col text-[#DDD3E0] shadow-2xl">
          <h1>About.</h1>
          <p className="font-light pt-3">Wikitreedia generates visualizations for the network created by embedded articles in Wikipedia. 
          ...
          <div className='w-full h-full flex flex-col gap-2 items-center justify-center pt-2'>
            ...
            <div className='w-max h-max flex items-center'>
              ...
              <a href="https://github.com/armmahajan/wikitreedia" target="_blank" rel="noopener">
            ...
            <div className='w-max h-max flex items-center'>
              ...
              <a href="https://github.com/armmahajan/" target="_blank" rel="noopener">
            ...
            <div className='w-max h-max flex items-center'>
              ...
              <a href="https://www.linkedin.com/in/armaanmahajan/" target="_blank" rel="noopener">
